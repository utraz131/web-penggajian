...
<head>
    ...
    <title>Reset Kata Sandi - REXY CORP</title>
    ...
    <div class="flex w-full h-screen relative">
        ...
        <div class="hidden md:flex w-[40%] flex-col justify-center items-start px-16 relative z-20 bg-white">
            ...
            <div class="max-w-xs mt-20">
                <h1 class="text-3xl font-bold mb-4 tracking-wide uppercase animate-gradient">Buat Sandi Baru</h1>
                <p class="text-blue-400 text-lg leading-relaxed">Silakan masukkan kata sandi baru Anda untuk memulihkan akun.</p>
            </div>
        </div>
        ...
        <div class="w-full md:w-[60%] h-full relative bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 flex flex-col justify-center items-center">
            ...
            <div class="relative z-20 w-full max-w-sm px-6">
                ...
                <div class="text-center mb-8 text-white">
                    <h2 class="text-3xl font-medium tracking-wide mb-1">RESET PASSWORD</h2>
                    <p class="text-sm font-light uppercase tracking-widest text-blue-100">Simpan Sandi Baru Anda</p>
                </div>
                ...
                <form action="{{ route('password.update') }}" method="POST" class="space-y-4">
                    ...
                    <div class="relative group">
                        ...
                        <input type="email" name="email" value="{{ $email ?? old('email') }}" required readonly class="w-full pl-11 pr-4 py-3 bg-white border-0 rounded-full text-sm text-slate-500 cursor-not-allowed focus:outline-none shadow-lg opacity-75">
                    </div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" name="password" required class="w-full pl-11 pr-4 py-3 bg-white border-0 rounded-full text-sm text-slate-800 placeholder-slate-400 focus:ring-4 focus:ring-white/30 transition-all shadow-lg" placeholder="Kata Sandi Baru (Min 8 karakter)">
                    </div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" name="password_confirmation" required class="w-full pl-11 pr-4 py-3 bg-white border-0 rounded-full text-sm text-slate-800 placeholder-slate-400 focus:ring-4 focus:ring-white/30 transition-all shadow-lg" placeholder="Konfirmasi Kata Sandi Baru">
                    </div>
                ...
                <div class="mt-8 text-center">
                    <a href="{{ route('login') }}" class="text-sm text-blue-100 hover:text-white transition-colors flex items-center justify-center gap-2">
